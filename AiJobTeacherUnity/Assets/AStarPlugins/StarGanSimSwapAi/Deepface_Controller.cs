...
public class Deepface_Controller : MonoBehaviour
{
    ...
    public UnityEvent<Astar.REST.DeepFaceTech.ImageOutput> On_Receive_Results;
    ...
    public void Process_Results(Astar.REST.DeepFaceTech.ImageOutput data)
    {
    ...
    async public Task<Astar.REST.DeepFaceTech.JobListOutput> getJobList()
    {
